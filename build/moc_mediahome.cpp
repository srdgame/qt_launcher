...
void MediaHome::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MediaHome *_t = static_cast<MediaHome *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject MediaHome::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MediaHome.data,
      qt_meta_data_MediaHome,  qt_static_metacall, nullptr, nullptr}
};
...
void *MediaHome::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MediaHome.stringdata0))
        return static_cast<void*>(const_cast< MediaHome*>(this));
